...
class MainVC: UIViewController, UITableViewDelegate, UITableViewDataSource, NSFetchedResultsControllerDelegate {
    ...
    func generateTestData() {
        ...
        item.price = 1800.0
        item.details = "I can´t wait until the September event, i hope they release new MPB´s"
        ...
        item3.price = 11000.0
        item3.details = "I can´t wait until the September event, i hope they release new MPB´s"

        let item4 = Item(context: context)
        item4.title = "New MacBook Pro"
        item4.price = 1800.0
        item4.details = "This is a beautiful car, and one day i will own it"
